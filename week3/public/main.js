...
var EditorComponent = /** @class */ (function () {
    ...
    EditorComponent.prototype.initEditor = function () {
        ...
        this.collaboration.init(this.editor, this.sessionId)
            .subscribe(function (users) { return _this.users = users; }); //sessionId: No. of problem
...
var CollaborationService = /** @class */ (function () {
    ...
    CollaborationService.prototype.init = function (editor, sessionId) {
        ...
        this.collaborationSocket.on('userChange', function (userData) {
            console.log("collaboration user change: " + userData);
            _this._userSource.next(userData.toString());
        });
...
module.exports = __webpack_require__(/*! /home/xarry/CS503-1805/week3/oj-client/src/main.ts */"./src/main.ts");
