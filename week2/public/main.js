    ...
    EditorComponent.prototype.initEditor = function () {
        ...
        this.editor.on('change', function (e) {
            ...
            if (_this.editor.lastAppliedChange != e) {
                _this.collaboration.change(JSON.stringify(e)); //avoid forced change 
            }
        });
    };
...
//default problem
var DEAFAULT_PROBLEM = Object.freeze({
    id: 0,
    name: '',
    desc: '',
    difficulty: 'easy'
    ...
    ProblemDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.dataService.getProblem(+params['id'])
                .then(function (problem) { return _this.problem = problem; }); //+ means transfer string to integer
        });
    };
...
module.exports = __webpack_require__(/*! /home/xarry/CS503-1805_Yunpeng-Xu/week2/oj-client/src/main.ts */"./src/main.ts");
